...
export default function ReservationBookingSystem() {
  ...
  const fetchBookedTables = async () => {
    ...
    setIsLoading(true);
    try {
      const bookedTablesData = await firebaseService.getReservations(
        date,
        timeSlot
      );
  ...
  const completeReservation = async () => {
    ...
    try {
      ...
      const latestBookedTables = await firebaseService.getReservations(
        date,
        timeSlot
      );
      ...
      if (latestBookedTables.includes(selectedTable)) {
        setBookingError(
          "Sorry, this table was just booked by someone else. Please select another table."
        );
        setSelectedTable(null);
        setBookingStep(1);
      ...
      setBookingError(
        error.message ||
          "Failed to complete your reservation. Please try again."
      );
    } finally {
      setIsLoading(false);
    }
  ...
  const isTableSuitable = (tableSeats) => {
    ...
    return (
      tableSeats >= guests && tableSeats <= Math.max(guests + 2, guests * 1.5)
    );
  };
  ...
  const renderTableShape = (table) => {
    ...
    const baseClasses = `${getTableColor(
      table
    )} transition-all duration-300 flex items-center justify-center text-sm font-medium`;
  ...
  const generateReceipt = async () => {
    ...
    try {
      ...
      pdf.text("123 Gourmet Street, Foodville", 105, yPosition, {
        align: "center",
      });
      yPosition += 5;
      pdf.text("Tel: (555) 123-4567 • www.bobsfinedining.com", 105, yPosition, {
        align: "center",
      });
      yPosition += 15;
      ...
      pdf.text("Thank you for your reservation!", 105, yPosition, {
        align: "center",
      });
      yPosition += 5;
      pdf.text("Please arrive 5-10 minutes early", 105, yPosition, {
        align: "center",
      });
      yPosition += 5;
      pdf.text("Present this QR code at check-in", 105, yPosition, {
        align: "center",
      });
      yPosition += 10;
            ...
            <div className="space-y-4 mb-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Use my account details for the reservation
                  </p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    I'm making this reservation for another person
                  </p>
                </div>
              </button>
            </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Select your preferred date, time, and table to enjoy your dining
            experience at Bob's Restaurant.
          </p>
        </div>
          ...
          >
            ...
            <div className="mb-8 space-y-4 text-amber-900">
              ...
              <div className="flex justify-between">
                ...
                <span>
                  {reservationFor === "self" ? user?.fullName : guestName}
                </span>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            {bookingStep === 1 ? (
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                      ...
                      <div className="bg-gray-100 rounded-lg p-4 h-52 relative overflow-hidden">
                        {date && timeSlot ? (
                          isLoading ? (
                            ...
                            <>
                              {tables[activeSection].map((table) =>
                      ...
                      <div className="mt-2 text-sm text-gray-600 flex items-center">
                        ...
                        <span>
                          Numbers indicate how many guests can be seated at each
                          table
                        </span>
                      </div>
                    </div>
                ...
                <Button className="flex sm:hidden text-white relative top-10"
                onClick={()=>router.replace('/dashboard')}
                >
                    <ArrowLeft />
                    Go Back
                ...
                <div className="p-6 border-b">
                            ...
                            <span className="font-medium">
                              {
                                ...
                                (() => {
                                  let tableInfo = null;
                                  Object.values(tables).forEach(
                                    (sectionTables) => {
                                      const found = sectionTables.find(
                                  ...
                                  return tableInfo
                                    ? `${tableInfo.section} (${tableInfo.seats} seats)`
                                    : selectedTable;
                                })()
                              }
                            </span>
                  ...
                  <div className="bg-amber-50 border border-amber-200 text-amber-800 px-4 py-3 rounded-lg mb-6 flex items-start">
                    ...
                    <span>
                      ...
                      cancellation policy. We hold your table for 15 minutes
                      past your reservation time. Please call us if you're
                      running late.
                    </span>
                  </div>
